...
const Contact = () => {
  ...
  return (
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex gap-10 z-10 overflow-hidden'>
      ...
      <label htmlFor="" className="flex flex-col">
        ...
        <input type="text" name='email' value={form.email} onChange={handleChange} placeholder="Your email" className='bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outlined-none border-none font-medium' />
      </label>
